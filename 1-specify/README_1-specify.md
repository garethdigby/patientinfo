# Patient Information Silos Problem Specification  

During the problem specification phase a problem related to healthcare is proposed. In addition to the problem, the context, who is closest to the problem, and why the problem matters now, are also included in the problem statement.  

# Patient Info Problem Statement
